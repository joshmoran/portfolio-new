    ...
    <div id="container">
        ...
        <div class="itemProject">
            ...
            <div id="right">
                ...
                <p><strong>Languages: </strong> HTML, CSS and JavaScript</p>
                <p><strong>Progress: </strong> Completed</p>
                <div class="projectLinks">
        ...
        <div class="itemProject">
            ...
            <div id="right">
                ...
                <p><strong>Languages: </strong> HTML, CSS, JavaScript, SQL and PHP</p>
                <p><strong>Progress: </strong> Completed</p>
                <div class="projectLinks">
        ...
        <div class="itemProject">
            ...
            <div id="right">
                <h2>Python Weather</h2>
                <p>A simple weather script using weather data from JSON files</p>
                <p><strong>Languages: </strong> Python and JSON</p>
                <p><strong>Progress: </strong> Completed</p>
                <div class="projectLinks">
        ...
        <div class="itemProject">
            ...
            <div id="right">
                <h2>Quiz</h2>
                <p>A simple quiz using JSON files</p>
                <p><strong>Languages: </strong> Python and JSON</p>
                <p><strong>Progress: </strong> Completed</p>
                <div class="projectLinks">
        ...
        <div class="itemProject">
            ...
            <div id="right">
                <h2>Python Music Playlist</h2>
                <p>A simple music playlist </p>
        ...
        <div class="itemProject">
            ...
            <div id="right">
                <h2>Python Expense Tracker</h2>
                <p>A simple financial tracker</p>
                <p><strong>Languages: </strong> Python</p>
                <p><strong>Progress: </strong> Completed</p>
                <div class="projectLinks">
        ...
        <div class="itemProject">
            ...
            <div id="right">
                <h2>Code Academy Landing Page Duplicate</h2>
                <p>A clone of the landing page CodeAcademy uses</p>
                <p><strong>Languages: </strong> HTML and CSS</p>
                <p><strong>Progress: </strong> Completed</p>
                <div class="projectLinks">
        ...
        <div class="itemProject">
            ...
            <div id="right">
                ...
                <p><strong>Languages: </strong> JavaScript, ReactJS and CSS</p>
                <p><strong>Progress: </strong> Completed</p>
                <div class="projectLinks">
        ...
        <div class="itemProject">
            ...
            <div id="right">
                <h2>RAADS-R Autism Test</h2>
                <p>This will be my description for the project</p>
                <p><strong>Languages: </strong> PHP, HTML, CSS and JavaScript</p>
                <p><strong>Progress: </strong> Completed</p>
                <div class="projectLinks">
